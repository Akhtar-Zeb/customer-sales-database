...
def transactions_bonus(inputfile):
    ...
    with open(output_file, "w") as outfile:
        writer = csv.writer(outfile, lineterminator='\n')
        # Give file a Header row
        writer.writerow(["customer_id", "product_id", "sale_month", "sale_year", "unit_sale_bonus", "product_rate", "total_bonus_amount"])
...
def transactions_return(inputfile):
    ...
    os.makedirs(f"clean_data/{company_name}", exist_ok=True)
    # Save output file to clean_data folder
    output_file = f"clean_data/{company_name}/transactions_return_clean.csv"
...
def transactions_bonus_return(inputfile):
    ...
    os.makedirs(f"clean_data/{company_name}", exist_ok=True)
    # Save output file to clean_data folder
    output_file = f"clean_data/{company_name}/transactions_bonus_return_clean.csv"
    ...
    with open(output_file, "w") as outfile:
        writer = csv.writer(outfile, lineterminator='\n')
        # Give file a Header row
        writer.writerow(["customer_id", "product_id", "sale_month", "sale_year", "unit_bonus_return", "product_rate", "total_bonus_return_amount"])
